...
class Fighter:
    ...
    def attack(self, target, attack_type):
        ...
        if attack_type == 'special':
            ...
            self.combo_step = 1; self.perform_attack('light1', target); self.combo_input_timer = 0
    ...
    def move(self, target):
        ...
        can_move = not self.attacking and not self.hit and not self.defending and not self.rolling and not self.dead
        if self.rolling:
        ...
        if self.is_player_one and can_move:
        ...
        elif not self.is_player_one and can_move:
